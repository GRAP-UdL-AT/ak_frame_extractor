...
from src.video_extraction_management.frame_extraction import FramesVideoManager
from src.video_extraction_management.video_helpers.helpers import colorize
...
class TestFramesManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.a_video_input_file = os.path.join(self.root_folder, 'data', '20210927_114012_k_r2_e_000_150_138.mkv')
        self.depth_name = '20210927_114012_k_r2_e_000_150_138_D.png'
    ...
    def test_get_a_frame(self):
        ...
        cv2.imwrite(os.path.join(self.output_folder, self.depth_name), colorize(a_depth_data, (None, 5000)))
        # cv2.waitKey()
    ...
    def test_export_frames_to_files(self):
        ...
        frames_extractor_config_obj = FramesManagerConfig()
        frames_extractor_obj = FramesVideoManager(frames_extractor_config_obj, self.a_video_input_file)
        [frames_written, errors, output_folder] = frames_extractor_obj.export_frames_to_files(self.a_track_file, self.offset_in_seconds, self.number_of_frames)
