...
class FramesVideoManager:
    ...
    def export_frames_to_files(self, track_file, start_offset, number_of_frames=None, filename=None):
        ...
        try:
            ...
            while frames_written < number_of_frames:
                ...
                if capture.transformed_depth is not None:
                    ...
                    sio.savemat(os.path.join(self._frame_video_config.path_images_output, img_write_filename_depth_mat),
                                depth_dict)
                ...
                if capture.transformed_ir is not None:
                    ...
                    sio.savemat(os.path.join(self._frame_video_config.path_images_output, img_write_filename_ir_mat),
                                ir_dict)
        ...
        playback.close()
        errors = "STRING_ERROR"
        output_folder = self._frame_video_config.path_images_output
        ...
        try:
            ...
            while frames_written < number_of_frames:
                ...
                img_write_filename_RGB = filename + '_' + self._frame_video_config.rgb_data_filename + '_' + str(
                    start_offset) + '_' + str(frames_written) + self._frame_video_config.file_img_extension
                ...
                img_write_filename_depth_mat = filename + '_' + self._frame_video_config.depth_data_filename + '_' + str(
                    start_offset) + '_' + str(frames_written) + '_' + self._frame_video_config.file_mat_extension
                ...
                if capture.depth is not None:
                    cv2.imwrite(os.path.join(self._frame_video_config.path_images_output, img_write_filename_depth),
                ...
                if capture.ir is not None:
                    cv2.imwrite(os.path.join(self._frame_video_config.path_images_output, img_write_filename_ir),
